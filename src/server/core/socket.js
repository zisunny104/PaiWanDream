...
class Socket {
  ...
  listen(socket) {
    ...
    socket.on(Constants.MSG_TYPES.SET_FAMILY, this.game.setPlayerFamily.bind(this.game, socket));
    socket.on(Constants.MSG_TYPES.SET_HEAD_SIDE, this.game.setPlayerHeadSide.bind(this.game, socket));
