  ...
  update() {
    ...
    if (this.createCardTime <= 0) {
      ...
      card_pos_id.forEach(pid => {
        let id = getRandom(5, 49);
        if (this.cards.includes(card_list[id].file_name)) {
          id = getRandom(5, 49);
        }
        ...
        if (pid < 12) {
          ...
          this.cards.push(new Card(card_pos_x[pid], card_pos_y[pid],
            card_list[id].type,
            card_list[id].card_name,
            card_list[id].raw_name,
            card_list[id].description,
            card_list[id].file_name,
          ));
        } else {
          id = getRandom(50, 59);
          if (this.cards.includes(card_list[id].file_name)) {
